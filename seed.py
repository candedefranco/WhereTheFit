...
POSTS = [
    ...
    {
        "title": "Quién customiza jeans con pines y broches así?",
        "description": "Busco a alguien que customice jeans con safety pins, broches de perla y cadenas como este. O si es una marca, necesito saberla. En Buenos Aires si es posible.",
        "category": "Pantalones",
    ...
    {
        "title": "De dónde son estas botitas cowboy color suela?",
        "description": "Busco unas botitas cowboy/texanas color suela o marrón claro, con punta. No muy altas, tipo al tobillo. Las de la foto son perfectas. Alguien las vio en algún local?",
        "category": "Zapatos",
        "tags": "botas,cowboy,texanas,suela,punta",
        "latitude": -34.6345,
        "longitude": -58.4065,
    ...
    {
        "title": "Necesito este cinturón rojo ancho con hebilla grande",
        "description": "Busco un cinturón ancho de cuero rojo con hebilla plateada rectangular grande tipo statement. Lo vi en una foto con un traje gris y queda increíble. Dónde lo encuentro?",
        "category": "Accesorios",
        "tags": "cinturon,rojo,ancho,hebilla,statement",
        "latitude": -34.6158,
        "longitude": -58.4333,
    ...
    {
        "title": "De dónde es este abrigo negro largo recto?",
        "description": "Busco un abrigo/tapado negro largo bien estructurado, corte recto sin cintura. Tipo paletó pero más largo. Que sea de paño grueso. Alguna marca argentina que haga algo así?",
        "category": "Abrigos",
        "tags": "abrigo,negro,largo,paleto,minimalist",
        "latitude": -34.5553,
        "longitude": -58.4617,
        "images": [f"{S3_BASE}/total_black_abrigo.jpg"],
    },
    {
        "title": "Campera de cuero negra con botones, no la típica",
        "description": "Busco una campera de cuero negra corta pero que NO sea la clásica de cierre. Esta tiene botones tipo militar y cuello con solapa. Alguien la vio en algún local o feria?",
        "category": "Abrigos",
    ...
    {
        "title": "Dónde consigo un sweater rojo lana así?",
        "description": "Busco un sweater rojo bien saturado de lana gruesa. No el típico finito que se transparenta. Quiero uno bien de invierno, pesado, color rojo fuerte. Alguna lanera o marca que haga?",
        "category": "Abrigos",
        "tags": "sweater,rojo,lana,grueso,invierno",
        "latitude": -34.6068,
        "longitude": -58.4077,
    ...
    },
    {
        ...
        "description": "Quiero un blazer marrón chocolate bien oversized como el de la foto. Que las mangas queden largas para arremangar. Color marrón oscuro. Talle S que quede grande. Alguna tienda en CABA?",
        "category": "Abrigos",
